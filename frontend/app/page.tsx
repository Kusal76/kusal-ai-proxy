...
export default function PortfolioChat() {
    ...
    const handleSend = async (
        ...
        // --> Close mobile menu if a project button was clicked from the sidebar
    ...
    return (
        <div
            className={`flex h-[100dvh] min-h-0 overflow-hidden overscroll-none transition-colors duration-300 ${bg} ${primaryText}`}
        >
      ...
      ===================================================== */}
            ...
            <aside
                className={`fixed inset-y-0 left-0 z-50 flex w-[280px] max-w-[calc(100vw-1rem)] shrink-0 flex-col border-r transform transition-transform duration-300 lg:static lg:w-[275px] lg:max-w-none lg:translate-x-0 ${surface} ${border} ${isMobileMenuOpen ? "translate-x-0 shadow-2xl" : "-translate-x-full"
                    }`}
            >
                ...
                <div className="flex min-h-0 flex-1 flex-col overflow-y-auto overflow-x-hidden scrollbar-none [&::-webkit-scrollbar]:hidden">
                    ...
                    {/* Profile */}
                    <div
                        className={`relative border-b px-5 py-5 ${border}`}
                    >
                        {/* Mobile Close Button */}
                        <button
                            onClick={() => setIsMobileMenuOpen(false)}
                ...
                {/* Bottom Links */}
                <div
                    className={`mt-auto shrink-0 border-t px-5 py-4 pb-[calc(1rem+env(safe-area-inset-bottom))] ${border} bg-inherit`}
                >
                ...
                >
                    <div className="min-w-0 flex-1 flex items-center gap-2 sm:gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                            <div className="flex min-w-0 items-center gap-2">
                                ...
                                <span
                                    className={`rounded-full px-2 py-0.5 text-[9px] font-semibold hidden sm:inline-block ${isDark
                            ...
                            <p
                                className={`mt-0.5 sm:mt-1 text-[10px] sm:text-[11px] truncate ${muted}`}
                            >
                    ...
                    <div className="flex shrink-0 items-center gap-1 sm:gap-2">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className={`inline-flex shrink-0 items-center gap-1.5 sm:gap-2 rounded-lg border px-2.5 py-1.5 text-[10px] sm:text-[11px] font-semibold transition sm:px-3 ${isDark
                        ...
                        <button
                            ...
                            className={`rounded-lg p-2 transition inline-flex ${isDark
                        ...
                        <button
                            ...
                            onClick={clearChat}
                            disabled={isLoading}
                            className={`hidden sm:inline-flex rounded-lg p-2 transition disabled:opacity-40 ${isDark
                        ...
                        {messages.map(
                            (msg, idx) => (
                                ...
                                >
                                    ...
                                    <div
                                        className={`flex min-w-0 max-w-[95%] sm:max-w-[90%] gap-2.5 sm:gap-3 ${msg.role === "user"
                                            ? "flex-row-reverse"
                                            : "flex-row"
                                            }`}
                                    >
                                        ...
                                        {/* Avatar */}
                                        <div
                                            className={`mt-1 flex h-7 w-7 sm:h-8 sm:w-8 shrink-0 items-center justify-center rounded-lg ${msg.role === "user"
                                                ? "bg-blue-600"
                                                : isDark
                                        ...
                                        >
                                            ...
                                            {msg.role ===
                                                ...
                                                <>
                                                    <div
                                                        className={`prose prose-sm max-w-none break-words overflow-x-auto leading-relaxed [overflow-wrap:anywhere] ${isDark
                                                            ? "prose-invert"
                                                            : ""
                                                            }`}
                                                    >
                                                    ...
                                                    <div
                                                        className={`mt-4 border-t pt-2 flex justify-end ${isDark
                                                            ? "border-gray-800"
                                                            : "border-gray-100"
                                                            }`}
                                                    >
                                                ...
                                                <div
                                                    className={`flex items-center gap-2 text-[11px] sm:text-xs ${muted}`}
                                                >
                ...
                >
                    <div className="mx-auto w-full max-w-6xl px-3 py-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))] sm:px-8 sm:py-4">
                                ...
                                {messages.length === 1 ? (
                                    suggestedQuestions.map((question) => (
                                        <button
                                            ...
                                            disabled={isLoading}
                                            className={`shrink-0 rounded-full border px-3 py-1.5 text-[10px] sm:text-[11px] font-medium transition ${isDark
                                    ...
                                    quickActions.map(
                                        (action) => (
                                            <button
                                                ...
                                                className={`flex shrink-0 items-center gap-1.5 whitespace-nowrap rounded-full border px-3 sm:px-3.5 py-1.5 text-[10px] sm:text-[11px] font-medium transition ${action.actionType ===
                                                    "fill"
                                                    ? isDark
                        ...
                        {inputMode ===
                            "job_fit" && (
                                <div
                                    className={`mb-2 flex items-center justify-between rounded-lg border px-3 py-2 text-[10px] sm:text-[11px] ${isDark
                        ...
                        <form
                            ...
                            className={`relative min-w-0 flex items-end rounded-xl border p-1 sm:p-2 transition focus-within:border-blue-400 focus-within:ring-2 focus-within:ring-blue-500/10 ${isDark
                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                <textarea
                                    ...
                                    className={`w-full max-h-40 sm:max-h-60 resize-none overflow-y-auto border-0 bg-transparent px-2 sm:px-3 pt-2.5 pb-2 text-[13px] sm:text-sm leading-6 outline-none placeholder:text-gray-400 disabled:opacity-50 ${isDark
                                        ? "text-gray-100"
                                        : "text-gray-900"
                                        }`}
                                />
                                ...
                                <div className="flex min-w-0 items-center justify-between gap-2 px-2 pb-1">
                                    ...
                                    <div
                                        className={`min-w-0 max-w-[78%] flex items-center gap-1.5 truncate text-[9px] sm:text-[10px] ${muted}`}
                                    >
                                        <FileText size={11} />
                                    ...
                                    <span
                                        className={`hidden min-w-0 flex-1 truncate pr-2 text-right text-[10px] ${faint} sm:block`}
                                    >
                        ...
                        <div
                            className={`mt-2.5 flex items-center justify-center gap-1.5 text-[9px] sm:text-[10px] ${faint}`}
                        >
